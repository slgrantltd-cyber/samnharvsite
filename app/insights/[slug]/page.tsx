    ...
    "@graph": [
      {
        ...
        inLanguage: "en-GB",
        author: { "@id": "https://www.samnharv.com/#org" },
        publisher: { "@id": "https://www.samnharv.com/#org" },
        mainEntityOfPage: `https://www.samnharv.com/insights/${post.slug}`,
      },
      {
        "@type": "BreadcrumbList",
        itemListElement: [
          { "@type": "ListItem", position: 1, name: "Home", item: "https://www.samnharv.com" },
          { "@type": "ListItem", position: 2, name: "Insights", item: "https://www.samnharv.com/insights" },
          { "@type": "ListItem", position: 3, name: post.title, item: `https://www.samnharv.com/insights/${post.slug}` },
        ],
      },
    ],
  };
