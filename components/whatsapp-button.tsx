...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-40 flex h-12 items-center gap-0 rounded-full bg-[#1a1a1a] pl-3 pr-3 text-[#ead8ab] shadow-daylight ring-1 ring-[#c9ab7c]/60 transition-all duration-500 hover:gap-3 hover:bg-[#ead8ab] hover:pr-5 hover:text-[#1a1a1a] hover:ring-[#ead8ab] md:bottom-7 md:right-7"
    >
