  ...
  return (
    <div className="pointer-events-none absolute inset-0 hidden overflow-hidden md:block" aria-hidden="true">
      <div
        ...
        style={{ background: "radial-gradient(closest-side, rgba(43,74,53,0.22) 0%, rgba(43,74,53,0.08) 35%, rgba(43,74,53,0) 62%)" }}
      />
      <div
        ref={amber}
        className="absolute left-1/2 top-1/2 h-[110vmax] w-[110vmax] -translate-x-1/2 -translate-y-1/2 opacity-60 will-change-transform"
        style={{ background: "radial-gradient(closest-side, rgba(226,150,90,0.22) 0%, rgba(226,150,90,0.08) 35%, rgba(226,150,90,0) 62%)" }}
      />
    </div>
  );
}
